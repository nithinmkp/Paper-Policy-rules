...
(\#eq:eq2)
\end{equation}
where $\delta=1+\alpha$ and $\mu=R^*-\alpha \pi^*$
...
constrained discretion limits the class of Taylor rules to those where $\alpha>0$ and $\gamma >0$.
> 0.
